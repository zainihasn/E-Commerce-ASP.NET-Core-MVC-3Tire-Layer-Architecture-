        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_GuestInfo_GuestId",
                        column: x => x.GuestId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductReview_GuestInfo_GuestId",
                        column: x => x.GuestId,
                        principalTable: "GuestInfo",
                        principalColumn: "GuestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "d59319d9-4f1f-48eb-b36d-1289374944f3", "d59319d9-4f1f-48eb-b36d-1289374944f3", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "9274a1e0-9442-4312-80c4-033a07823730", 0, "9274a1e0-9442-4312-80c4-033a07823730", "admin@gmail.com", true, false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEB+8sFAvTMP4L1XG/RPYunbgh/NiL1rl8i+MpFogG6+hJKovrxkJnPWy7lYOgPrrSQ==", null, false, "51f28336-bb9d-44a7-8e9f-51ed44f72cbd", false, "admin@gmail.com" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "d59319d9-4f1f-48eb-b36d-1289374944f3", "9274a1e0-9442-4312-80c4-033a07823730" });
